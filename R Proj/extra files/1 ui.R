...
shinyUI(navbarPage("Network Analysis : Based on Communication Network",                     
  tabPanel("Network",
  ...
  tabPanel("Organisational Strategic Unit ",
  ...
  tabPanel("Organisational Operational Unit ",
           # Show a plot of the generated distribution
           mainPanel(      
             ...
             plotOutput("OperationalUnitPlayers")      
             # plotOutput("distPlot")      
           )  
  ),
  tabPanel("Information / Inventory Flow Path ",
           # Show a plot of the generated distribution
           mainPanel(      
  ...
  tabPanel("Information Broadcasters / Trace Candidate ",
           # Show a plot of the generated distribution
           mainPanel(      
             h4("information radiators"),
...
#   "),
  ...
  Similarly Ahmed Alhaznaw, Saeed Alghamdi, Ahmed Alnaw and friend represented in green crashed
      UA #93 into Pennsylvania"),
             plotOutput("OperationalUnits")      
             # plotOutput("distPlot")      
           )           
  ),  
  tabPanel("Coordinators ",
           # Show a plot of the generated distribution
           mainPanel(      
